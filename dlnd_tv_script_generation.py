...
def build_nn(cell, rnn_size, input_data, vocab_size, embed_dim):
    ...
    ret = tf.contrib.layers.fully_connected(outputs, vocab_size, activation_fn=None)
...
#     print('seq_length : ', seq_length)
    ...
    for batch_size_id in range(batch_size):
        for batch_id in range(batchs):
            
            st = (batch_size_id * batchs + batch_id) * seq_length
            ed = st + seq_length
            ret[batch_id, 0, batch_size_id, :] = int_text[st : ed]
            ret[batch_id, 1, batch_size_id, :] = int_text[st + 1 : ed + 1]
...
def get_tensors(loaded_graph):
    ...
    input_ph = loaded_graph.get_tensor_by_name('input:0')
    initial_state = loaded_graph.get_tensor_by_name('initial_state:0')
    final_state = loaded_graph.get_tensor_by_name('final_state:0')
    probs = loaded_graph.get_tensor_by_name('probs:0')
    return input_ph, initial_state, final_state, probs
...
#     show_len = 5
#     st = max(0, idx - 5)
#     print(probabilities[st: idx + show_len])
#     print('get {} / {}'.format(idx, len(int_to_vocab)))
